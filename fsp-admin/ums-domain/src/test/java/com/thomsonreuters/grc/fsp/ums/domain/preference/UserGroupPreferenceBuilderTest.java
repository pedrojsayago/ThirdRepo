 ...
 */
@Transactional
public class UserGroupPreferenceBuilderTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserGroupPreferenceBuilderTest.class);

    @Test
    public void canCreateUserGroupPreferenceBuilder() {
        ...
        UserGroupPreference.Builder userGroupPreferenceBuilder =
                new UserGroupPreference.Builder();
        UserGroupPreference userGroupPreference = userGroupPreferenceBuilder
                .withGroup(aGroup)
                .withType(UserGroupPreferenceType.FOO)
                .withUser(anUser)
                .build();

        LOGGER.debug("this is the user group Preference {}", userGroupPreference);
    }
}
